...
import (
	...
	"github.com/reviewtool/reviewdog/cienv"
	"github.com/reviewtool/reviewdog/commands"
	"github.com/reviewtool/reviewdog/filter"
	"github.com/reviewtool/reviewdog/parser"
	"github.com/reviewtool/reviewdog/project"
	bbservice "github.com/reviewtool/reviewdog/service/bitbucket"
	gerritservice "github.com/reviewtool/reviewdog/service/gerrit"
	githubservice "github.com/reviewtool/reviewdog/service/github"
	"github.com/reviewtool/reviewdog/service/github/githubutils"
	gitlabservice "github.com/reviewtool/reviewdog/service/gitlab"
)
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "See https://github.com/reviewtool/reviewdog for more detail.")
	os.Exit(2)
}
...
func runList(w io.Writer) error {
	...
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjson", "Reviewdog Diagnostic JSON Format (JSON of DiagnosticResult message)", "https://github.com/reviewtool/reviewdog")
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjsonl", "Reviewdog Diagnostic JSONL Format (JSONL of Diagnostic message)", "https://github.com/reviewtool/reviewdog")
