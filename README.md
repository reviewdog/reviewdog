...
- [Supported CI services](#supported-ci-services)
  * [Travis CI](#travis-ci)
    ...
    + [Travis CI (-reporter=github-pr-review)](#travis-ci--reportergithub-pr-review)
  * [Circle CI](#circle-ci)
    + [.circleci/config.yml sample](#circleciconfigyml-sample)
  * [GitLab CI](#gitlab-ci)
